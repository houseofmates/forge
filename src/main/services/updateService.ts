...
class UpdateService extends EventEmitter {
  ...
  private async fetchCommitsBetweenVersions(
    ...
    try {
      ...
      const currentTagResponse = await axios.get(
        `https://api.github.com/repos/houseofmates/forge/git/ref/tags/v${currentVersion}`
      )
      ...
      const commitsResponse = await axios.get(
        `https://api.github.com/repos/houseofmates/forge/commits?since=${new Date(
  ...
  public async checkForUpdates(): Promise<void> {
    ...
    try {
      ...
      const response = await axios.get(
        'https://api.github.com/repos/houseofmates/forge/releases/latest'
      )
  ...
  public openReleasesPage(): void {
    const releasesUrl = 'https://github.com/houseofmates/forge/releases'
  ...
  public openRepositoryPage(): void {
    const repositoryUrl = 'https://github.com/houseofmates/forge'
